        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <div className="mt-6">
              ...
              <a href="/guides" className="ml-4 inline-block bg-transparent border border-white text-white px-6 py-3 rounded-lg shadow-sm hover:bg-white/10 transition">Browse Guides</a>
            </div>
          </div>
